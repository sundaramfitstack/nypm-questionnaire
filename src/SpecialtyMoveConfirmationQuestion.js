  ...
  render(){
    return (
      <div>
        ...
        <br/>
        <span className="smallprint">To help you prepare for your move, we've put together <a href="#" onClick={this.viewTheGuideButtonOnClick}>The Ultimate Specialty Moving Guide: Moving Tips & Tricks To Make Your Life Easier.</a> If you find the guide useful, please share it!</span>
        <br/>        
